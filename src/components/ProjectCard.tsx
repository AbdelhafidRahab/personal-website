        ...
        {project.stats && (
          <div className="absolute bottom-3 start-3 z-10">
            <span className="flex items-center gap-1.5 px-3 py-1 text-xs font-bold bg-indigo-600/90 backdrop-blur-md text-white rounded-full shadow-lg">
              <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3">
      ...
      <div className="flex flex-col grow p-6">
        ...
        <div className="flex items-center gap-3 mt-auto pt-4 border-t border-neutral-800">
          {project.links.demo && (
            ...
            >
              <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg>
              {t('live_demo')}
            </Link>
          )}
